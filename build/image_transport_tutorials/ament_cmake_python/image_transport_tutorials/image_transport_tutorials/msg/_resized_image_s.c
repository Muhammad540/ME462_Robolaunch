...
bool image_transport_tutorials__msg__resized_image__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("image_transport_tutorials.msg._resized_image.ResizedImage", full_classname_dest, 57) == 0);
  }
  image_transport_tutorials__msg__ResizedImage * ros_message = _ros_message;
  {  // original_height
...
PyObject * image_transport_tutorials__msg__resized_image__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("image_transport_tutorials.msg._resized_image");
