...
static const _ResizedImage_type_support_symbol_names_t _ResizedImage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, image_transport_tutorials, msg, ResizedImage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, image_transport_tutorials, msg, ResizedImage)),
  }
};
...
{
  return &::image_transport_tutorials::msg::rosidl_typesupport_cpp::ResizedImage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, image_transport_tutorials, msg, ResizedImage)() {
  return get_message_type_support_handle<image_transport_tutorials::msg::ResizedImage>();
}
