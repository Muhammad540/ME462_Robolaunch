...
static const _LedControl_Request_type_support_symbol_names_t _LedControl_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, led_interfaces, srv, LedControl_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, led_interfaces, srv, LedControl_Request)),
  }
};
...
{
  return &::led_interfaces::srv::rosidl_typesupport_cpp::LedControl_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, led_interfaces, srv, LedControl_Request)() {
  return get_message_type_support_handle<led_interfaces::srv::LedControl_Request>();
}
...
static const _LedControl_Response_type_support_symbol_names_t _LedControl_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, led_interfaces, srv, LedControl_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, led_interfaces, srv, LedControl_Response)),
  }
};
...
{
  return &::led_interfaces::srv::rosidl_typesupport_cpp::LedControl_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, led_interfaces, srv, LedControl_Response)() {
  return get_message_type_support_handle<led_interfaces::srv::LedControl_Response>();
}
...
static const _LedControl_type_support_symbol_names_t _LedControl_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, led_interfaces, srv, LedControl)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, led_interfaces, srv, LedControl)),
  }
};
...
{
  return &::led_interfaces::srv::rosidl_typesupport_cpp::LedControl_service_type_support_handle;
}
